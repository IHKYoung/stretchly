...
- Pauza doesn't need to restart after Restoring remote settings
- Updated many translations
...
- Contributor preference option to make Pauza act as a regular window (to make use of other apps during breaks easier)
...
### Changed
- changed app name from `stretchly` to `Pauza`
