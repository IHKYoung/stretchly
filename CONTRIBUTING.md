...
Once you are sure that the maintainer of *Pauza* will accept your proposed changes, feel free to open PR once you start working on it, so anyone can review and comment on your code.

Other things to keep in mind:
- use `node` version from `package.json`
- write tests if possible
- add yourself to [README](https://github.com/hovancik/stretchly#contributors)
- add your changes to [docs/CHANGELOG.md](https://github.com/hovancik/stretchly/blob/master/docs/CHANGELOG.md) and write them in Simplified Chinese
...
Thanks for your interest in making *Pauza* better!
